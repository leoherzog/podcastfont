	...
	body
		...
		p
			...
			a href="https://code.podlibre.org/podlibre/podcastfont/-/issues/new?issue[title]=Icon request: icon-name&issue[description]=Please provide SVG file and all useful information here." target="_blank" data-analytics='"Contact",{{"props":{{"Via":"Gitlab"}}}}'
				| request an Icon
			|  or 
			a href="https://code.podlibre.org/podlibre/podcastfont/-/issues/new?issue[title]=Error reporting: icon-name&issue[description]=Please provide all useful information here." target="_blank" data-analytics='"Contact",{{"props":{{"Via":"Gitlab"}}}}'
				| report an error
			| .
		h2 | Source Code
		p
